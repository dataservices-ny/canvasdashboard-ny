...
class RedisSessionInterface(SessionInterface):
    ...
    def open_session(self, app, request):
        sid = request.cookies.get(self._get_cookie_name(app))
        if not sid:
    ...
    def save_session(self, app, session, response):
        ...
        if not session:
            if session.modified:
                ...
                response.delete_cookie(self._get_cookie_name(app),
        ...
        response.set_cookie(self._get_cookie_name(app), session_id,
