...
@Component({
  ...
  template: `
  <svg class="bi bi-chat-square-quote-fill" width=".813em" height=".813em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
export class CommentIcon implements OnInit {
